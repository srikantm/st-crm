...
import { createInvoiceForm } from '@/app/lib/actions';
...
export default function Form({ customers, currencies, taxes, packages, leads }: { customers: CustomerField[],
  ...
  const [formData, setFormData] = useState<CreateInvoiceForm>({
    ...
    customerId: "",
    leadId:"",
    invoiceNumber: `INV${(new Date).valueOf().toString()}`,
    currencyId: "",
    currencySymbol: "",
    invoiceStatus: "",
    invoiceDate: "",
