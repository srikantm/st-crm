import { DeactivateProduct, UpdateProduct, ViewProduct, UploadProductImage, MapProductImagePopup } from '@/app/ui/products/buttons';
                ...
                >
                  ...
                  <td className="whitespace-nowrap py-2 pl-3 pr-3">
                    <div className="flex justify-center gap-3">
                      ...
                      <MapProductImagePopup id={(product.package_id)} />
