                ...
                <div className="bg-gray-50 border border-gray-200 rounded-md">
                    ...
                    <div className="flex flex-grow">
                        <div className="p-5 mb-5 basis-1/3">
                            ...
                            />
                            {flightDetails.source === '' && <label htmlFor="error" className={`${font.className} mb-2 block text-sm text-red-500`}></label>}
                        </div>
                        <div className="p-5 mb-5 basis-1/3">
                            ...
                            />
                            {flightDetails.destination === '' && <label htmlFor="error" className={`${font.className} mb-2 block text-sm text-red-500`}></label>}
                        </div>
                        ...
                        <div className="p-5 mb-5 basis-1/3">
                            <div className="relative">
                                ...
                                {flightDetails.airline === '' && <label htmlFor="error" className={`${font.className} mb-2 block text-sm text-red-500`}></label>}
                    ...
                    <div className="flex flex-grow">
                        <div className="p-3 mb-5 basis-1/3">
                            ...
                            {flightDetails.depatureDateTime === '' && <label htmlFor="error" className={`${font.className} mb-2 block text-sm text-red-500`}></label>}
                        </div>
                        <div className="p-3 mb-5 basis-1/3">
                            ...
                            {flightDetails.arrivalDateTime === '' && <label htmlFor="error" className={`${font.className} mb-2 block text-sm text-red-500`}></label>}
                        </div>
                    </div>
                </div>
